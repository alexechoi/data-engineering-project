...
def get_weather_data_from_file(json_file_path, api_key, duration_days, save_file_path='weather-output.json'):
    ...
    # Loop through all latitudes and longitudes and call the request_data_and_save() function for each pair
...
get_weather_data_from_file('/project/coordinates.json', 'c074b46ec5bfcb0091f23a91b46c79a2', 1, save_file_path='weather-output_trial.json')
